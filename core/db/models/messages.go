...
type Message struct {
	...
	MessageType null.Int    `boil:"message_type" json:"message_type,omitempty" toml:"message_type" yaml:"message_type,omitempty"`
...
var MessageTableColumns = struct {
	...
	User1ID:     "messages.user1_id",
	User2ID:     "messages.user2_id",
...
var MessageWhere = struct {
	...
	MessageType whereHelpernull_Int
	Content     whereHelpernull_String
}{
	MessageID:   whereHelperstring{field: "\"messages\".\"message_id\""},
	User1ID:     whereHelperstring{field: "\"messages\".\"user1_id\""},
	User2ID:     whereHelperstring{field: "\"messages\".\"user2_id\""},
	MessageType: whereHelpernull_Int{field: "\"messages\".\"message_type\""},
...
var (
	messageAllColumns            = []string{"message_id", "user1_id", "user2_id", "message_type", "content"}
	messageColumnsWithoutDefault = []string{"user1_id", "user2_id"}
	messageColumnsWithDefault    = []string{"message_id", "message_type", "content"}
...
// CountG returns the count of all Message records in the query using the global executor
...
func FindMessageG(ctx context.Context, messageID string, selectCols ...string) (*Message, error) {
...
func (o *Message) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to upsert messages")
	}
...
func (o *Message) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbmodels: no Message provided for reload")
	}
...
func (o *MessageSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbmodels: empty MessageSlice provided for reload all")
	}
...
func MessageExistsG(ctx context.Context, messageID string) (bool, error) {
